...
def exportar_excel(df, nombre_file, proyecto):
    ...
    ubicacion_final_baseglobal = DATA_ANALYTICS + "BD VIVA/DATA DEL MERCADO CON SCRAPPING/CERCADO especial/" + nombre_file + ".xlsx"
    base = "C:/Users/diego.dinatale/OneDrive - Aenza/LOCAL_MACHINE/DATA_ANALYTICS/"
    fecha = datetime.datetime.now().strftime("%d_%m_%Y")
    nombre_file = f"{nombre_file}_{fecha}"
    ubicacion_final_baseglobal = f"{base}BD VIVA/DATA DEL MERCADO CON SCRAPPING/CERCADO especial/{nombre_file}.xlsx"
...
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Gran Central Colonial II")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Nova")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Checor Las Magnolias")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Central Park")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Amatista")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Alto Alborada")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Jardines de Santa Beatriz II")
exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Albamar RE")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Duetto 846 Fase II")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Minimal")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Novo 3")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Torre Castelo")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "S14 Apartments")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Checor Las Dalias")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Helio Santa Beatriz")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Quantua Fase 1")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Centriqo Club Condominio Ecoamigable")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Nueva Metrópolis")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Albamar Arenales")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Ciudaris Iconik Park")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Roble")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Cedro 33")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Alameda Central")

#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Concepto Urban Park")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Albamar Bea")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Urban Tower 3")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Qantua Fase 2")

#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Park Living")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Duetto 846")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Pietra Centrale")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Céntrico")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Edificio Vista verde")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Invent Tirado")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Alto Lima Park")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Smart A")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Tulipan")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Cool Living")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Central Home")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Santorini")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Evolution")
#exportar_excel(df_comas_cleaned_actualizado, nombre_file="Lima Proyecto", proyecto = "Edificio Los Pinos III")
